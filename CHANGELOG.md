...
- **`/stockpile manage`**: ephemeral panel for soft-delete select, **Cleanup** (purge marked-deleted only), and **Delete all** (wipe every depot). Public **`/stockpile list`** keeps reset buttons only.
